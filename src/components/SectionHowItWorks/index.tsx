...
import { Section, ContentTitle, Title, BorderBottom, ContentParagraph, TitleParagraph, Paragraph } from './styles';

export function SectionHowItWorks() {
  return (
    <Section>
      <ContentTitle>
        <Title>Sua página vendedora online em poucos minutos</Title>
        <BorderBottom />
      </ContentTitle>
      <ContentParagraph>
