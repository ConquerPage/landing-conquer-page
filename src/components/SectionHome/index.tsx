    ...
    <SectionContainer>
      <ContentAni>
        <ContentLeftAni>
          ...
          <p>
            Descubra que com alguns cliques, de forma simples, você conseguirá
            criar páginas irresistíveis para transformar seus visitantes em
            clientes.{' '}
        ...
        <ContentRightAni>
          <Image
            src={BannerHome}
            alt="Crie páginas de alta conversão"
            width={0}
            height={0}
            layout="responsive"
            priority
      ...
      <Link href="#conheca" passHref aria-label="Como funciona">
